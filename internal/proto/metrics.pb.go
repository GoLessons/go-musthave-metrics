...
const file_metrics_proto_rawDesc = "" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseB?Z=github.com/GoLessons/go-musthave-metrics/internal/proto;protob\x06proto3"
